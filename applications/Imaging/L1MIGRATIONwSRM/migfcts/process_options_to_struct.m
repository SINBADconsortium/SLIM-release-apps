...
function [opts,unused] = process_options_to_struct(args, varargin)
...
% merge external options dict
if exist('external_dict') == 1
    opts = catstruct(opts, external_dict);
end
