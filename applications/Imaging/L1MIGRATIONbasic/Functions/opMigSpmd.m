...
%
    ...
    methods
       ...
       % Constructor
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       function op = opMigSpmd(U,R,freq,nx,nz,nx_border,nz_border,xd,zd,vel)
		...
		fun = @(x,mode) opMigSpmd_intrnl(U,R,freq,n,nr,ns,nf,nx,nz,nx_border,nz_border,xd,zd,sigma,vel,x,mode);
...
function y = opMigSpmd_intrnl(U,R,freq,n,nr,ns,nf,nx,nz,nx_border,nz_border,xd,zd,sigma,vel,x,mode) 
