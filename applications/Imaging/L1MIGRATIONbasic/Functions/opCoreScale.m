...
%
    ...
    methods
       ...
       % Constructor
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       function op = opCoreScale(m,n,nbscales,nbangles,finest,subscale,ttype)
    ...
    methods ( Access = protected )
       ...
       function x = multiply(op,x,mode)
         if mode == 1 
            ...
            for mm = op.subscale:length(x)
			   for nn = 1:length(x{mm})
				   x{mm}{nn} = zeros(size(x{mm}{nn}));
			   end
			end
