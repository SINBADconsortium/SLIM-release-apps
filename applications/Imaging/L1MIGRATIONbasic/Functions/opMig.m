...
%
    ...
    methods
       ...
       % Constructor
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       function op = opMig(R,freq,nx,nz,nx_border,nz_border,xd,zd,vel,b)
		...
		fun = @(x,mode) opMig_intrnl(R,freq,n,nr,ns,nf,nx,nz,nx_border,nz_border,xd,zd,sigma,vel,b,x,mode);
...
function y = opMig_intrnl(R,freq,n,nr,ns,nf,nx,nz,nx_border,nz_border,xd,zd,sigma,vel,b,x,mode) 
