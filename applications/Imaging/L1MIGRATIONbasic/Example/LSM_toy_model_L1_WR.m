%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  L1 constrained least-squares Migration with toy model (one layer)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
nf          = 3;                               % # of frequencies used in imaging.
...
l1mode      = 6;                                % 
name    = ['LSM_Toy_model_L1_WR'];      % name of result
