...
snapshot_file = [resultdir,'/MigTotalFD_iwave_26ss31freq_EstQ_GausEnc_wAmpCor_IG1_BS_snapshots.mat'];
result_file = [resultdir,'/MigTotalFD_iwave_26ss31freq_EstQ_GausEnc_wAmpCor_IG1_BS.mat'];
...
S_f_full = freq.^2.*exp(-(freq/15).^2).*exp(1i*2*pi* freq*(-0.056));
