...
snapshot_file = [resultdir,'/MigTotalFD_iwave_26ss31freq_bg_TrueQ_GaussianEnc_snapshots.mat'];
result_file = [resultdir,'/MigTotalFD_iwave_26ss31freq_bg_TrueQ_GaussianEnc.mat'];
