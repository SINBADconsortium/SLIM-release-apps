...
data_file = [datadir,'/data_iwave_f.mat'];
model_file = [datadir,'/model.mat'];
snapshot_file = [resultdir,'/iwave_finv_estQ_GaussianEnc2_snapshots.mat'];
result_file = [resultdir,'/iwave_finv_estQ_GaussianEnc2.mat'];
...
scale_op = 1/40000;
load(data_file,'data');
data = vec(distributed(reshape(data,[nrec,nsrc,nf])));
D = scale_op*data;
...
curvelet_denoise_gen(result_file, 0.01, op)
