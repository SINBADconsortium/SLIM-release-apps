...
snapshot_file = [resultdir,'/linear_wrongQ2_GaussianEnc2_snapshots.mat'];
result_file = [resultdir,'/linear_wrongQ2_GaussianEnc2.mat'];
...
curvelet_denoise_gen(result_file, 0.005, op)
