...
% 
%
% .source_est           - if true, estimate the source weights (false)
%
...
%        a=PDEopts2D.default_source_est      
...
%            opts.source_est         = PDEopts2D.default_source_est;
%            opts.source_est        = a;
