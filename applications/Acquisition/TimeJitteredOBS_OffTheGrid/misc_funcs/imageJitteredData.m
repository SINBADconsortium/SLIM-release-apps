...
% View the data
figure
imagesc(real(data(t1/dt:t2/dt, :)), [-caxmin caxmax]); colormap(cmap); 
xlabel('Receiver position (m)', 'FontSize', fsize_label, 'FontName', fontname, 'FontWeight', fontweight);
ylabel('Recording time (s)', 'FontSize', fsize_label, 'FontName', fontname, 'FontWeight', fontweight);
set(gca, 'Fontsize', fsize_axis, 'FontName', fontname, 'FontWeight', fontweight, 'YTick', time_axis, 'YTickLabel', time_axis_label, 'XTick', rec_axis, 'XTickLabel', rec_axis_label);
