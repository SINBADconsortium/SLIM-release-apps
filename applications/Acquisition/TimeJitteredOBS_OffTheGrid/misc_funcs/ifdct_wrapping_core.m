function X = ifdct_wrapping_core(C, M, N)
...
%   M, N        Size of the Fourier domain matrix to be recovered
%
% Outputs
%   x           M-by-N matrix in the Fourier domain
%
% See also fdct_wrapping_core.m
%
% Original code (fdct_wrapping.m) by Laurent Demanet, 2004
% Modified by Gilles Hennenfent, 2008
%   - output x is in the Fourier domain
%   - type of curvelet transform is set to complex (is_real = 0)
