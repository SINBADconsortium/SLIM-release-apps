% This script sets the parameters to view the results of the jitacq_deblending_LR.m script.
...
if ~exist(expdir,'dir')
   error('The corresponding experiment directory does not exist. Please check if you have run the main script (jitacq_deblending_LR.m)');
end
cd(expdir);
...
% View a time, receiver, and source gather of the data recovered after
% rank-minimization
if L1RecovData,
...
% View a time, receiver, and source gather of the difference between original and recovered data 
if L1DiffData,
