% This script performs the missing-trace interpolation on Gulf of Suez data set.
...
options.result     = 'GulfofSuezinterp'; % output file name                           
...
options.rank       = floor(linspace(20,50,floor(options.ntime/2)+1)); % rank can be a single number or vector.
                            ...
                            % to the length of fequency axis along which we
