...
function test_mvtree_multiplication(d)
   import('spot.utils.*')
...
function test_mvtree_ctranspose(d)
   import('spot.utils.*')
...
function test_mvtree_scalars(d)
   import('spot.utils.*') 
...
function test_mvtree_sums_diffs_sup(d)
...
function test_mvtree_sums_diffs_sub(d)
...
function test_mvtree_concatentation(d)
