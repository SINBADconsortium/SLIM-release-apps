...
[verbose,numDiff,optTol,maxIter,suffDec,interp,method,corrections,damped,obj_aux] = ...
    myProcessOptions(...
    options,'verbose',3,'numDiff',0,'optTol',1e-6,'maxIter',500,'suffDec',1e-4,...
    'interp',1,'method','lbfgs','corrections',100,'damped',0,'obj_aux',0);
...
while funEvals <= maxIter
    ...
    err = 0;%[err norm(x-options.mtrue)];
