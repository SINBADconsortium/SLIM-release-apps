...
[verbose,numDiff,optTol,progTol,maxIter,suffDec,interp,memory,useSpectral,curvilinear,feasibleInit,testOpt,bbType,testEvol,evol_tol] = ...
    myProcessOptions(...
    ...
    'testOpt',0,'bbType',1,'testEvol',1,'evol_tol',1e-4);
...
t = t/2;
    ...
    if testEvol
        if ((norm(x_new-x)/norm(x) < evol_tol) && (lineSearchIters<3) && (i>3))
