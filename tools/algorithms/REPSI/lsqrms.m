function [ x, istop, itn, r1norm, r2norm, anorm, acond, arnorm, xnorm, var ]...
  = lsqrms( m, n, aprodname, iw, rw, b, damp, atol, btol, conlim, itnlim, show )
% NOTE: this is slightly modified to not crash when working with distributed b
...
%     See if it is time to print something.
      ...
      if prnt == 1
         if show
            str1 = sprintf( '%6g %12.5e',        itn, undist(x(1)) );
            str2 = sprintf( ' %10.3e %10.3e', r1norm, r2norm );
            str3 = sprintf( '  %8.1e %8.1e',   test1,  test2 );
