function [x, residual, residual_list, iters_performed, sigma_reached] = EPSI_SLIM_invertForG_L1(A, b, sigma, xprev, tau, options)
% L1 inversion for primary impulse response (using SPGL1)
