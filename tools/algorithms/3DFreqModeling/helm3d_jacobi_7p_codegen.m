function helm3d_7p_jacobi_codegen
...
alpha = coder.typeof(double(0),1,1);
b = coder.typeof(complex(double(0),double(0)),[Inf 1]);


% all of the arguments to this function
args = {wn,h,n,npml,freq,alpha,b,x,mode};

% run Matlab Coder
codegen('helm3d_7pt_jacobi','-config',cfg,'-args',args);
end